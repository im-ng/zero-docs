...
_But `zero` framework provides option to automate and add migrations/data systematically. More on [Migrations](/0.15.2/migrations.md)_
...
<img
    slot="first"
    style="width: 100%"
    src="/preview-db-connection.webp"
/>
<img
    slot="second"
    style="width: 100%"
    src="/preview-db-data.webp"
/>
<!-- eslint-enable -->
</ImgComparisonSlider>
...
In this demo, we successully created database, added basic information, connected from zero framework app and retrieved the data as intented. This is just a beginning, we can do more and explained in [HTMX](/0.15.2/htmx-crud.md) example.
