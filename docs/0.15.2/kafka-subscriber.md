...
It is continuation of the [Publisher](/0.15.2/kafka-publisher) to preview the subscriber demo. Prefer to read that first.
...
<img
    slot="first"
    style="width: 100%;"
    src="/zero-kafka-subscriber.webp"
/>
<img
    slot="second"
    style="width: 100%"
    src="/zero-kafka-publisher.webp"
/>
</ImgComparisonSlider>

4. `zero` comes with subscriber metrics handy to preview success/failed counts.

![metrics](/zero-kafka-subscriber-3.webp)
