...
This document is continuation of the [Publisher](/0.15.2/message-queue-publisher) to preview the subscriber demo. Prefer to read that first.
...
<img
    slot="first"
    style="width: 100%"
    src="/preview-mqtt-subscription.webp"
/>
<img
    slot="second"
    style="width: 100%"
    src="/preview-mqtt-publisher-2.webp"
/>
<!-- eslint-enable -->
</ImgComparisonSlider>
